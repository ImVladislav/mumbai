...
d3.json(
  "//static.redsift.io/three/t3-rs-geo/latest/grid-hq.json",
  function (world) {
    ...
    console.log("Globe DOM Element:", globe.domElement);

    node.appendChild(globe.domElement);
          ...
          .call(
            d3
              ...
              .on("drag", () => {
                ...
                globe.viewAngle = Math.max(
                  Math.min(newA, Math.PI / 2.0),
                  -Math.PI / 2.0
                );
              })
              .on("end", () => {
...
console.log(typeof t3_rs_geo);
console.log(t3_rs_geo);
